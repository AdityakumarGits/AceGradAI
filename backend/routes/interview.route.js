...
router.post( "/startInterview",protect,startInterviewLimiter,upload.single("resume"),startInterview,);

// candidate ka spoken-answer 'audio' field-name se aayega
//protected route
router.post("/submitAnswer",protect, submitAnswerLimiter,upload.single("audio"), submitAnswer,);
