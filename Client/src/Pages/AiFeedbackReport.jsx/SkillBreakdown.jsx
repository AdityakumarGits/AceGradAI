...
export default function SkillBreakdown({ evaluation }) {
  const metrics = [
    {
      ...
      <div className="relative p-8">
        ...
        <div>
          ...
          <p className="mt-2 text-[#eaecf0]/60">
            AI-generated evaluation across technical knowledge,
            communication, problem-solving, and overall performance.
          </p>
        </div>
