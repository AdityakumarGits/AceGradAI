...
export default function TranscriptCritique({
  ...
  // --------------------------------------------------
  // Merge original interview answers with AI evaluation
  // --------------------------------------------------
            ...
            transcripts.map((item, idx) => (
              ...
              >
                ...
                <div className="mt-6 rounded-2xl border border-white/10 bg-[#030712]/70 p-5">
                  ...
                  <p className="whitespace-pre-wrap leading-8 text-[#eaecf0]/70">
                      ...
                      {!item.whatWasGood &&
                        ...
                        !item.feedback && (
                          <p className="mt-4 text-sm text-[#eaecf0]/50">
                            No detailed AI feedback available for this
                            response.
                          </p>
                        )}
                    </div>
