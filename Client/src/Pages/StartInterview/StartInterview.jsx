...
export default function StartInterview() {
  ...
  // Welcome-message sirf-ek-baar bolna hai — ye flag isko-track-karta-hai
  ...
  // =========================================================
  // 3. QUESTION CHANGE → WELCOME (first time) OR TTS
  // =========================================================
  ...
  useEffect(() => {
    ...
    if (!hasWelcomedRef.current) {
      ...
      speakWelcomeThenQuestion(question);
    } else {
  ...
  // =========================================================
  // 4. TTS — GENERIC AUDIO-PLAY HELPER
  // =========================================================
  ...
  // Transcription-panel me hamesha current-question dikhta rahega,
  // status-line (neeche) hi badalta hai isSpeaking/isRecording/isSubmitting se
    ...
    <div className="flex h-screen flex-col overflow-hidden bg-gradient-to-br from-[#030712] via-[#070f2b] to-[#0f172a] text-[#eaecf0]">
      ...
      {errorMsg && (
        <div className="mx-6 mt-4 flex items-center justify-between rounded-lg border border-red-500/30 bg-red-500/10 px-4 py-2 text-sm text-red-400">
          ...
          {!isSpeaking && !isRecording && !isSubmitting && questions.length > 0 && (
            <button
              type="button"
